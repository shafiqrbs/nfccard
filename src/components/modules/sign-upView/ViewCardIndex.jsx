...
function ViewCard() {
    ...
    return (
        <Box pt={2}>
            <ScrollArea p={0} h={{ base: height + 20, md: height - 15 }} scrollbarSize={2} scrollbars="y" type="never" mb={2} className={'boxBackground borderRadiusAll'}>
                <Flex justify="center" align="center" bg='#154549'>
                    <Card
                        shadow="xl"
                        pt="lg"
                        pl="lg"
            ...
            <Box pl={`sm`} pb={{ base: 'xs', sm: 'xs', md: 'xs' }} pr={8} pt={'xs'} className={'boxBackground borderRadiusAll'}  >
                <Grid span={12}>
                    <Grid.Col >
                        <Stack right align="flex-end" h={{ base: 38, md: 22 }}>
                            <>
                                {
                                    <Button
                                        size="xs"
